"""
Pydantic schemas for generic job run management.
"""
...
class JobRunResponse(BaseModel):
    ...
    message: Optional[str] = Field(None, description="Optional message (error or success details)")
    created_at: datetime = Field(..., description="Timestamp when the job was created")
    started_at: Optional[datetime] = Field(None, description="Timestamp when the job started")
